...
<script>
  ...
  function userChange(userName) {
    ...
    //     userName.parentNode.nextElementSibling.nextElementSibling.firstElementChild.innerHTML = user.sign
    //     userName.parentNode.nextElementSibling.nextElementSibling.lastElementChild.value = user.sign
    //     break
    //   }
    // }
