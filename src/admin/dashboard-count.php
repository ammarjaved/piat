...
(SELECT count(*) as klb_count FROM ad_service_qr WHERE ba = 'KLB - 6121' AND status = 'Inprocess' AND tarikh_siap >= :from AND tarikh_siap <= :to)a,
(SELECT count(*) as klt_count FROM ad_service_qr WHERE ba = 'KLT - 6122' AND status = 'Inprocess' AND tarikh_siap >= :from AND tarikh_siap <= :to)b,
(SELECT count(*) as klp_count FROM ad_service_qr WHERE ba = 'KLP - 6123' AND status = 'Inprocess' AND tarikh_siap>= :from AND tarikh_siap <= :to)c,
(SELECT count(*) as kls_count FROM ad_service_qr WHERE ba = 'KLS - 6124' AND status = 'Inprocess' AND tarikh_siap >= :from AND tarikh_siap <= :to)d,
(SELECT count(*) as total_klb_count FROM ad_service_qr WHERE ba = 'KLB - 6121' AND status = 'Complete' OR status = '1' AND tarikh_siap>= :from AND tarikh_siap <= :to)e,
(SELECT count(*) as total_klt_count FROM ad_service_qr WHERE ba = 'KLT - 6122' AND status = 'Complete' OR status = '1' AND tarikh_siap >= :from AND tarikh_siap <= :to)f,
(SELECT count(*) as total_klp_count FROM ad_service_qr WHERE ba = 'KLP - 6123' AND status = 'Complete' OR status = '1' AND tarikh_siap >= :from AND tarikh_siap <= :to)g,
(SELECT count(*) as total_kls_count FROM ad_service_qr WHERE ba = 'KLS - 6124' AND status = 'Complete' OR status = '1' AND tarikh_siap >= :from AND tarikh_siap <= :to)h");
